...
/*   Updated: 2019/10/29 14:26:41 by vrobin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_all(t_stack *stack, t_string *string, int nb)
{
	free(stack->tab_a);
	free(stack->tab_b);
	free(stack);
